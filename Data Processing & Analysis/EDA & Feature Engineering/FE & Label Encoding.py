...
def main():
    ...
    df = spark.read.csv("/home/beboy/Documents/projects/scale/Data Processing & Analysis/DEA & Feature Engineering/cleaned_dataset.csv/cleaned_dataset.csv", header=True,
                        schema=schema)
